      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="space-y-6 lg:space-y-8 order-2 lg:order-1">
            <div className="space-y-4">
              ...
              <p className="text-base sm:text-lg text-gray-600 leading-relaxed max-w-xl">
                Book expert home grooming or visit trusted partner salons across
                Delhi NCR.
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button
                asChild
                className="bg-[#0C3C85] hover:bg-blue-700 text-white font-semibold shadow-md hover:shadow-lg px-8 py-3.5 text-base h-auto rounded-lg"
              >
                <Link href="/services/home">Home Services</Link>
              </Button>
              <Button
                asChild
                variant="outline"
                className="text-[#0C3C85] border-[#0C3C85] border-2 hover:bg-[#0C3C85] hover:text-white px-8 py-3.5 text-base h-auto rounded-lg font-semibold"
              >
                <Link href="/services/salon">Salon Services</Link>
              </Button>
            </div>
          ...
          <div className="relative h-[400px] sm:h-[500px] lg:h-[600px] rounded-2xl overflow-hidden shadow-2xl order-1 lg:order-2">
            ...
            <Image
              src="/images/groomsta-hero.png"
              alt="Groomsta Premium Grooming"
              fill
              priority
